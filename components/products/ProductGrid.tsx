      ...
      <section className="w-full bg-gray-50 py-8 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-4">
            <h2 className="text-3xl md:text-4xl font-title text-gray-900">
            ...
            <div className="relative">
              <select 
                ...
                className="appearance-none bg-white border border-gray-200 rounded-full px-6 py-2 pr-10 text-sm text-gray-900 focus:outline-none focus:border-primary cursor-pointer hover:border-gray-300 transition-colors bg-no-repeat"
                style={{ 
                ...
                {products.map((product) => {
                  ...
                  return (
                    <Link href={`/products/${product.slug}`} key={product._id} className="group">
                      <div className="relative aspect-square w-full rounded-2xl overflow-hidden mb-4 bg-white shadow-sm hover:shadow-md transition-all duration-300">
                        {primaryImage ? (
                          <Image
                            src={primaryImage}
                            alt={product.name}
